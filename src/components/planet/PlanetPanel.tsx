import {
  ...
  ANCIENT_RELIC_DAMAGE_MULTIPLIER, ANCIENT_RELIC_ECONOMY_MULTIPLIER, BROOD_BIOMASS_PER_PLANET, STELLAR_HAZARD_DAMAGE_PER_SECOND, carrierFighterCount, empireCivilization, formatFactionCost, groundProductionMultiplier, hasUnlimitedBuildingCapacity, isBuildingOperational, isColonizableWorld, isDefenseBuildingKind, spaceProductionMultiplier, spaceYards, systemKind, unitRange, visibleOrbitUnits,
