...
export const unitGlyph = (kind: UnitKind) => kind === 'infantry' ? '♟' : kind === 'antiVehicle' ? '⌁' : kind === 'recon' ? '◇' : kind === 'lightTank' ? '▰' : kind === 'artillery' ? '⌖' : kind === 'shockTrooper' ? '♞' : kind === 'railgunTank' ? '▱' : kind === 'plasmaTank' ? '⬣' : kind === 'siegeWalker' ? '♜' : kind === 'defenseTurret' ? '⌂' : kind === 'broodling' ? '✣' : kind === 'acidSpitter' ? '◔' : kind === 'skitterer' ? '⌁' : kind === 'carapaceBeast' ? '⬢' : kind === 'sporeLobber' ? '✺' : kind === 'synapseGuard' ? '♛' : kind === 'crusherBeast' ? '⬟' : kind === 'acidBehemoth' ? '◉' : kind === 'siegeCrawler' ? '✹' : kind === 'spineTower' ? '♜' : kind === 'transport' || kind === 'sporeArk' ? '△' : kind === 'destroyer' || kind === 'voidStalker' ? '◉' : kind === 'assaultCarrier' || kind === 'broodCarrier' ? '⬡' : kind.includes('Frigate') ? '◈' : kind === 'battlecruiser' || kind === 'leviathan' ? '✦' : kind === 'dreadnought' || kind === 'worldEater' ? '✹' : '◆';
