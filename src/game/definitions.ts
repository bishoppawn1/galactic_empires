...
export const UNITS: Record<UnitKind, UnitDefinition> = {
  ...
  falconGunship: { label: 'Falcon Gunship', description: 'An armored atmospheric bomber that crosses terrain to deliver sustained surface fire.', cost: pool(155, 92, 46), time: 38, factory: 'ground', hp: 310, shields: 85, range: 24, visionRange: 30, moveSpeed: 7.5, flying: true, groundTargeting: 'surface', weapon: { label: 'Paired Falcon Cannons', damage: 3.2, cooldown: .7, projectiles: 2, effect: 'pulse' }, requires: 'groundWarfare', advancedFactory: true, ability: { kind: 'airSupport', label: 'Air Support', description: 'Flies over rocks, ignores forest cover, and attacks surface targets only.' } },
