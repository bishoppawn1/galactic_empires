...
export const unitGlyph = (kind: UnitKind) => kind === 'infantry' || kind === 'aegisWarden' || kind === 'covenantCohort' ? '♟' : kind === 'antiVehicle' ? '⌁' : kind === 'recon' || kind === 'covenantRepairDrone' ? '◇' : kind === 'lightTank' || kind === 'aegisBastionTank' || kind === 'covenantBastionStrider' ? '▰' : kind === 'artillery' || kind === 'aegisRampartArtillery' || kind === 'covenantFurnaceArtillery' ? '⌖' : kind === 'shockTrooper' || kind === 'aegisPaladinGuard' ? '♞' : kind === 'railgunTank' ? '▱' : kind === 'plasmaTank' ? '⬣' : kind === 'siegeWalker' || kind === 'aegisFortressWalker' || kind === 'covenantJuggernaut' ? '♜' : kind === 'defenseTurret' || kind === 'covenantBulwark' ? '⌂' : kind === 'broodling' ? '✣' : kind === 'acidSpitter' ? '◔' : kind === 'skitterer' ? '⌁' : kind === 'carapaceBeast' ? '⬢' : kind === 'sporeLobber' ? '✺' : kind === 'synapseGuard' ? '♛' : kind === 'crusherBeast' ? '⬟' : kind === 'acidBehemoth' ? '◉' : kind === 'siegeCrawler' ? '✹' : kind === 'spineTower' ? '♜' : kind === 'transport' || kind === 'sporeArk' || kind === 'aegisBastionLander' || kind === 'covenantAssemblyArk' ? '△' : kind === 'destroyer' || kind === 'voidStalker' ? '◉' : kind === 'assaultCarrier' || kind === 'broodCarrier' || kind === 'aegisCitadelCarrier' || kind === 'covenantFabricatorCarrier' ? '⬡' : kind.includes('Frigate') || kind === 'aegisShieldMonitor' ? '◈' : kind === 'battlecruiser' || kind === 'leviathan' || kind === 'aegisWardCruiser' || kind === 'covenantFoundryCruiser' || kind === 'covenantIronclad' ? '✦' : kind === 'dreadnought' || kind === 'worldEater' || kind === 'aegisSovereignDreadnought' || kind === 'covenantDreadforge' ? '✹' : '◆';
