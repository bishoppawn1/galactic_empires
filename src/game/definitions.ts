...
export const UNITS: Record<UnitKind, UnitDefinition> = {
  ...
  broodCarrier: { label: 'Brood Carrier', description: 'A mobile hive whose attack spawn split apart to overwhelm multiple ships.', cost: pool(350, 232, 130), time: 54, factory: 'space', hp: 720, shields: 220, range: 300, moveSpeed: 0, weapon: { label: 'Attack Spawn', damage: 1.4, cooldown: .7, projectiles: 6, effect: 'drone' }, requires: 'carrierOperations', advancedFactory: true, capacity: 10, ability: { kind: 'spawnCloud', label: 'Spawn Cloud', description: 'Every volley also attacks a second nearby hostile ship for 50% damage.' } },
