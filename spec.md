...
- Multiplayer signaling has a finite connection timeout, active disconnects end the versus session cleanly, and authoritative snapshots are validated before installation.
