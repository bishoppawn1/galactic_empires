...
const SHIP_IMAGES: Record<SpaceUnitKind, string> = {
  ...
  missileFrigate,
  flakFrigate,
  fleetTransportCruiser: lightCruiser,
  lightCruiser,
  destroyer,
  flakCruiser: destroyer,
  assaultCarrier,
  battlecruiser,
  missileBattleship: battlecruiser,
  flakBattleship: battlecruiser,
  dreadnought,
  sporeArk,
  clawFrigate,
  needleFrigate,
  ...
  hiveCruiser,
  voidStalker,
  broodNeedleCruiser: voidStalker,
  broodSporeguardCruiser: hiveCruiser,
  broodCarrier,
  leviathan,
  broodNeedleBattleship: leviathan,
  broodSporeguardBattleship: leviathan,
  worldEater,
  aegisBastionLander,
  aegisShieldMonitor,
  aegisLanceFrigate,
  aegisSentinelFrigate,
  aegisBastionCruiser: aegisWardCruiser,
  aegisWardCruiser,
  aegisLanceCruiser: aegisWardCruiser,
  aegisSentinelCruiser: aegisWardCruiser,
  aegisCitadelCarrier,
  aegisWardBattleship: aegisSovereignDreadnought,
  aegisLanceBattleship: aegisSovereignDreadnought,
  aegisSentinelBattleship: aegisSovereignDreadnought,
  ...
  covenantSalvageCruiser: covenantFoundryCruiser,
  covenantChainCruiser: covenantFoundryCruiser,
  covenantInterdictorCruiser: covenantFoundryCruiser,
  covenantFabricatorCarrier,
  covenantIronclad,
  covenantChainBattleship: covenantIronclad,
  covenantInterdictorBattleship: covenantIronclad,
  covenantDreadforge,
};
...
export const SHIP_DISPLAY_SIZES: Record<SpaceUnitKind, number> = {
  ...
  missileFrigate: 82,
  flakFrigate: 80,
  fleetTransportCruiser: 96,
  lightCruiser: 94,
  destroyer: 104,
  flakCruiser: 102,
  assaultCarrier: 116,
  battlecruiser: 126,
  missileBattleship: 130,
  flakBattleship: 128,
  dreadnought: 140,
  sporeArk: 72,
  clawFrigate: 82,
  ...
  hiveCruiser: 100,
  voidStalker: 108,
  broodNeedleCruiser: 104,
  broodSporeguardCruiser: 102,
  broodCarrier: 120,
  leviathan: 132,
  broodNeedleBattleship: 134,
  broodSporeguardBattleship: 132,
  worldEater: 148,
  aegisBastionLander: 78,
  aegisShieldMonitor: 84,
  aegisLanceFrigate: 88,
  aegisSentinelFrigate: 86,
  aegisBastionCruiser: 104,
  aegisWardCruiser: 104,
  aegisLanceCruiser: 108,
  aegisSentinelCruiser: 106,
  aegisCitadelCarrier: 128,
  aegisWardBattleship: 138,
  aegisLanceBattleship: 140,
  aegisSentinelBattleship: 138,
  ...
  covenantSalvageCruiser: 106,
  covenantChainCruiser: 110,
  covenantInterdictorCruiser: 108,
  covenantFabricatorCarrier: 126,
  covenantIronclad: 138,
  covenantChainBattleship: 140,
  covenantInterdictorBattleship: 138,
